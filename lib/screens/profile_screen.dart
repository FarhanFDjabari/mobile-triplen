    ...
    return BlocListener(
      ...
      listener: (context, state) {
        if (state is UserLoggedOutState) {
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => LoginScreen()), (Route<dynamic>
          route) => false);
        }
      },
      child: BlocBuilder(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          InkWell(
                            ...
                            child: Container(
                              padding: EdgeInsets.symmetric(vertical: 15, horizontal: MediaQuery.of(context).size.width
                                  / 4),
                              decoration: BoxDecoration(
